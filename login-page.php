...
<html>
	...
	<body>	
		<div class="wrapper">
			...
			<div id="content">
				<div id="center" class="center-login">
					<h2>Login</h2>
					<?php require_once('include/login_process.php'); ?>
					<div id="error-message">
						<?php 
							if (isset($message)) {
								echo "<script> $(function() {
													$('.center-login').css('height', '325px');
													$('#error-message').show();
					...
					<a href="media-login/login_facebook.php"><div class="login-div"><img src="images/facebook.png" width="25px" height="25px"/><p>Login with Facebook</p></div></a>			
					<a href="media-login/login_google.php"><div class="login-div"><img src="images/google_plus.png" width="25px" height="25px"/><p style="margin-left:67px;">Login with Google+</p></div></a>
					<form action="login-page.php" method="POST">
						<input type="text" name="email" placeholder="Email" value="<?php isset($email)? print $email : FALSE; ?>"/>
						<input type="password" name="password" placeholder="Password"/>
						<input id="login-account" type="submit" name="submit" value="Log In" />
						<a href="account_issue.php"><div id="account_issue">Issues</div></a> 
					</form>
				</div>
			</div>
    </div>
