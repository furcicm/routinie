 ...
 ?>
  ...
  <?php   if (!empty($user['gender'])) { ?>
    ...
    <div class="account-title account-subtitle">Social accounts</div>
      ...
      <a href="http://routinie.com/media-login/login_google.php"><div class="linked-account account-linkedin"><img src="/images/linkedin-account.png" /><p>Click to link your linkedin account</p></div>
      <div class="linked-account account-google linked-account-right"><img src="/images/google-account.png" /><p>Click to link your google+ account</p></div></a>
    </div>
